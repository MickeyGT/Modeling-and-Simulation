...
public class Main
{
	...
	private static void generate_Poisson(ArrayList<Integer>scores)
	{
		int nrOfGenerations = 100;
		Random rand = new Random();
		for (int i = 0; i < nrOfGenerations; i++)
		{
			scores.add(poisson(2));
		}
	}

	private static void generate_Binomial(ArrayList<Integer>scores)
	{
		int nrOfGenerations = 40;
		for (int i = 0; i < nrOfGenerations; i++)
		{
			scores.add(binomial(40,0.5));
		}
	}
	...
	public static void main(String[] args)
	{
		SwingUtilities.invokeLater(new Runnable()
		{
			public void run()
			{
				...
				generate_Poisson(scores);
				//generate_Binomial(scores);
